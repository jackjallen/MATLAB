...
//   M->GetPoint( M->GetCell(cellid)->GetPointId(2) , Q );
  ...
  T[1][2]=-(RP[2]*(RP[0]*RQ[0] + RP[1]*RQ[1]) - RQ[2]*(RP[0]*RP[0] + RP[1]*RP[1]))*Den;
    ...
    mexPrintf("cellid=%i",cellid);
    mexPrintf("R=%f %f \n", T[0][0]*R[0]+T[0][1]*R[1]+T[0][2]*R[2], T[1][0]*R[0]+T[1][1]*R[1]+T[1][2]*R[2]);
    mexPrintf("P=%f %f \n", T[0][0]*P[0]+T[0][1]*P[1]+T[0][2]*P[2], T[1][0]*P[0]+T[1][1]*P[1]+T[1][2]*P[2]);
    mexPrintf("Q=%f %f \n", T[0][0]*Q[0]+T[0][1]*Q[1]+T[0][2]*Q[2], T[1][0]*Q[0]+T[1][1]*Q[1]+T[1][2]*Q[2]);
  ...
  for( a = 0 ; a < nADDED ; a++ ){
    ...
    x = T[0][0]*XYZ[0]+T[0][1]*XYZ[1]+T[0][2]*XYZ[2];
    y = T[1][0]*XYZ[0]+T[1][1]*XYZ[1]+T[1][2]*XYZ[2];
...
//     if ((x+y)>1) {x=x-(x+y-1)/2;y=y-(x+y-1)/2;}
