function[dia_endo_covariance_matrix, dia_endo_mean_shape, sys_endo_covariance_matrix, sys_endo_mean_shape, sys_myo_covariance_matrix, sys_myo_mean_shape] = calcCovarianceMatrix(data, indices)
...
for i = indices'
    ...
    sys_myo_mean_shape =  sys_myo_sum_of_shapes/(size(indices,1));
end
