...
%%
factor1=nStd
DETERMINE_dia_sys_dEPI2ENDOs_plus(:,visualisingMode1) = DETERMINE_dia_sys_dEPI2ENDOs_mean(:) + principle_dia_sys_dEPI2ENDOs_eigenvectors(:,visualisingMode1)*(factor1)*DETERMINE_dia_sys_dEPI2ENDOs_max_b(visualisingMode1);
...
factor2=-nStd
DETERMINE_dia_sys_dEPI2ENDOs_minus(:,visualisingMode1) = DETERMINE_dia_sys_dEPI2ENDOs_mean(:) + principle_dia_sys_dEPI2ENDOs_eigenvectors(:,visualisingMode1)*(factor2)*DETERMINE_dia_sys_dEPI2ENDOs_max_b(visualisingMode1);
...
shape1 = DETERMINE_dia_sys_dEPI2ENDOs_minus(:,visualisingMode1) - MESA_dia_sys_dEPI2ENDOs_minus(:,visualisingMode1);
