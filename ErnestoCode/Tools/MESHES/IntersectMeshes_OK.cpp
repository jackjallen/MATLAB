...
//   TRI1.contour[0].vertex[2].y = ry+1.0;
  ...
  TRI1.contour[0].vertex[0].x = round( ( T[0][0]*(RA[0]-RA[0])+T[0][1]*(RA[1]-RA[1])+T[0][2]*(RA[2]-RA[2])+rx ) / g) * g ;
  TRI1.contour[0].vertex[0].y = round( ( T[1][0]*(RA[0]-RA[0])+T[1][1]*(RA[1]-RA[1])+T[1][2]*(RA[2]-RA[2])+ry ) / g) * g ;

  TRI1.contour[0].vertex[1].x = round( ( T[0][0]*(PA[0]-RA[0])+T[0][1]*(PA[1]-RA[1])+T[0][2]*(PA[2]-RA[2])+rx ) / g) * g ;
  TRI1.contour[0].vertex[1].y = round( ( T[1][0]*(PA[0]-RA[0])+T[1][1]*(PA[1]-RA[1])+T[1][2]*(PA[2]-RA[2])+ry ) / g) * g ;

  TRI1.contour[0].vertex[2].x = round( ( T[0][0]*(QA[0]-RA[0])+T[0][1]*(QA[1]-RA[1])+T[0][2]*(QA[2]-RA[2])+rx ) / g) * g ;
  TRI1.contour[0].vertex[2].y = round( ( T[1][0]*(QA[0]-RA[0])+T[1][1]*(QA[1]-RA[1])+T[1][2]*(QA[2]-RA[2])+ry ) / g) * g ;
  ...
  TRI2.contour[0].vertex[0].x = round( ( T[0][0]*(RB[0]-RA[0])+T[0][1]*(RB[1]-RA[1])+T[0][2]*(RB[2]-RA[2])+rx ) / g) * g ;
  TRI2.contour[0].vertex[0].y = round( ( T[1][0]*(RB[0]-RA[0])+T[1][1]*(RB[1]-RA[1])+T[1][2]*(RB[2]-RA[2])+ry ) / g) * g ;

  TRI2.contour[0].vertex[1].x = round( ( T[0][0]*(PB[0]-RA[0])+T[0][1]*(PB[1]-RA[1])+T[0][2]*(PB[2]-RA[2])+rx ) / g) * g ;
  TRI2.contour[0].vertex[1].y = round( ( T[1][0]*(PB[0]-RA[0])+T[1][1]*(PB[1]-RA[1])+T[1][2]*(PB[2]-RA[2])+ry ) / g) * g ;

  TRI2.contour[0].vertex[2].x = round( ( T[0][0]*(QB[0]-RA[0])+T[0][1]*(QB[1]-RA[1])+T[0][2]*(QB[2]-RA[2])+rx ) / g) * g ;
  TRI2.contour[0].vertex[2].y = round( ( T[1][0]*(QB[0]-RA[0])+T[1][1]*(QB[1]-RA[1])+T[1][2]*(QB[2]-RA[2])+ry ) / g) * g ;

  
//      char fn[1024];
//      sprintf( fn , "triangles/gpctriangle1.poly");
//      
//      FILE *fid = fopen( fn ,"w");
// 
//      fprintf( fid , "cA = %i \n" , cA );
//      fprintf( fid , "TA =[ %.20f %.20f %.20f\n"   , RA[0],RA[1],RA[2] );
//      fprintf( fid , "      %.20f %.20f %.20f\n"   , PA[0],PA[1],PA[2] );
//      fprintf( fid , "      %.20f %.20f %.20f ]\n" , QA[0],QA[1],QA[2] );
//      fprintf( fid , "A = [ %.20f %.20f \n"  , TRI1.contour[0].vertex[0].x,TRI1.contour[0].vertex[0].y );
//      fprintf( fid , "      %.20f %.20f \n"  , TRI1.contour[0].vertex[1].x,TRI1.contour[0].vertex[1].y );
//      fprintf( fid , "      %.20f %.20f ]\n" , TRI1.contour[0].vertex[2].x,TRI1.contour[0].vertex[2].y );
// 
//      fclose( fid );
// 
//      sprintf( fn , "triangles/gpctriangle2.poly");
//      fid = fopen( fn ,"w");
//      fprintf( fid , "cB = %i \n" , cB );
//      fprintf( fid , "TB =[ %.20f %.20f %.20f\n"   , RB[0],RB[1],RB[2] );
//      fprintf( fid , "      %.20f %.20f %.20f\n"   , PB[0],PB[1],PB[2] );
//      fprintf( fid , "      %.20f %.20f %.20f ]\n" , QB[0],QB[1],QB[2] );
//      fprintf( fid , "B = [ %.20f %.20f \n"  , TRI2.contour[0].vertex[0].x,TRI2.contour[0].vertex[0].y );
//      fprintf( fid , "      %.20f %.20f \n"  , TRI2.contour[0].vertex[1].x,TRI2.contour[0].vertex[1].y );
//      fprintf( fid , "      %.20f %.20f ]\n" , TRI2.contour[0].vertex[2].x,TRI2.contour[0].vertex[2].y );
// 
//      fclose( fid );
...
//   mexPrintf("Clip Done. Returning\n"); myFlush();
  ...
  if ( ( TRIO.num_contours > 0 ) && ( TRIO.contour[0].num_vertices > 1 ) )
